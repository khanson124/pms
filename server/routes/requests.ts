    ...
    asyncHandler(async (req, res) => {
        ...
        try {
            ...
            await auditService.log({
                ...
                entity: 'REQUEST',
                entityId: updated.id,
                message: 'Request self-assigned by Budget/Finance Manager',
                metadata: { type: 'SELF_ASSIGN', requestId: updated.id, stage: request.status },
            });
        } catch (e) {
    ...
    asyncHandler(async (req, res) => {
        ...
        try {
            ...
            await auditService.log({
                ...
                entity: 'REQUEST',
                entityId: updated.id,
                message: `Request assigned by Budget/Finance Manager to user ${Number(targetUserId)}`,
                metadata: { type: 'ASSIGN', requestId: updated.id, stage: request.status, toUserId: Number(targetUserId) },
            });
        } catch (e) {
